...
destnames=("CERN_DPM_TRUNK" "CERN_DPM_TRUNK" "DESY_DCACHETEST" "GRIDPP_DPM_EPELTEST" "GRIDPP_DPM_EPELTEST" "LNF_DPM_EPELTEST" "LNF_DPM_EPELTEST" "CERN_EOS" "CERN_EOS" "ZCU_DPM_RC" "CERN_LITTLEXRDHTTP" "CERN_LITTLEXRDHTTP" "BRUNEL_EPELTEST" "BRUNEL_EPELTEST" "LAPP_EPELTEST" "LAPP_EPELTEST" "DYNAFED_DESY")

# And this is a human readable word that tells us what we tested
desttag=("DPMhttps" "DPMxrootd" "DCACHEhttp" "DPMhttps" "DPMxrootd" "DPMhttps" "DPMxrootd" "EOSxrootd" "EOShttps" "DPMhttps" "LittleHTTPS" "Littlexrootd" "DPMhttps" "DPMxrootd" "DPMhttps" "DPMxrootd" "DYNAFEDhttps")
