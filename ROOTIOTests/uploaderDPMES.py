...
curlcommand = "curl %s %s -XPOST 'https://dashb-es-dev.cern.ch:9203/hammer_dpm_0/result/' -d '%s'" % (curlproxy, curlcacerts, str(doces).replace("'", '"'))
print "executing %s" % curlcommand
